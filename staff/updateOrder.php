...
<section class="update-order">
    ...
    <form action="" method="post">
        ...
        <select name="status" required>
            ...
            <option value="confirmed" <?php if ($fetch_order['status'] == 'Completed') echo 'selected'; ?>>Confirmed</option>
            <option value="Cancelled" <?php if ($fetch_order['status'] == 'Cancelled') echo 'selected'; ?>>Completed</option>
